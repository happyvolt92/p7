...
-- Inserting data into the "pizzeria" table
...
-- Inserting data into the "shopping_cart_pizza" table
...
INSERT INTO orders (idOrder, idCart, idConnexionClient, idPizzeria, OrderDate)
VALUES
  (1, 1, 1, 1, '2023-06-07'),
  (2, 2, 2, 2, '2023-06-08');
